  ...
  public void doFilterInternal(HttpServletRequest request,
    ...
    if (userName != null && SecurityContextHolder.getContext().getAuthentication() == null) {
      ...
      if (this.jwtService.isTokenValid(token, userDetails)) {
        ...
        /*
         * setDetails: Establece detalles adicionales de la autenticación, como la
         * dirección IP y la sesión de donde se realiza la solicitud
         */
        authToken.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));

        /*
         * Registra el token de autenticación en el contexto de seguridad efectivamente
         * autenticando al usuario para la duración de la solicitud
         */
