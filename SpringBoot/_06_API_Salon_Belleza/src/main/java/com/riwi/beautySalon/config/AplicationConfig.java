...
public class AplicationConfig {
  ...
  // Utiliza la configuración de spring security para obtener una configuración ya
  // preparada (la que viene por defecto)
  @Bean
  ...
  // Este método crea y configura un DaoAuthenticationProvider, que es una de las
  ...
  // Este servicio es utilizado por Spring Security para cargar detalles del
  ...
  // Este encoder es utilizado para encriptar y desencriptar las contraseñas en la
  // aplicacion
  // retorna una instacioa de BCryptPasswordEncoder , es un método de cifrado o
  // hash fuertemente y ampliamente utilizado
  @Bean
